...
void main() {
  ...
  test('a built-in style selects its own clause by id', () async {
    final o = freshOptions()..styleOverride = 'concise';
    final options = await build(o);
  ...
  test('the default style adds no clause at all', () async {
    final options = await build(freshOptions()..styleOverride = 'normal');
  ...
  test('a custom style overrides the built-in clause instead of stacking',
    ...
    final o = freshOptions()..styleOverride = style.id;
    final options = await build(o);
  ...
  test('the per-turn override beats the saved global style', () async {
